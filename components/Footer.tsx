  ...
  return (
    <footer className="footer">
      <div className="shell footerGrid">
        ...
        <div><h3>Platform</h3><Link href="/best-ai-agent">Best AI agent guide</Link><Link href="/agents">AI agents</Link><Link href="/categories">Categories</Link><Link href="/compare">Compare</Link><Link href="/india">Built in India</Link><Link href="/mcp">MCP</Link></div>
